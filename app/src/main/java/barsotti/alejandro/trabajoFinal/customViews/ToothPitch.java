...
import barsotti.alejandro.trabajoFinal.customInterfaces.IToothPitch;
...
//            // Dibujar borde del indicador de escala.
//            canvas.drawLines(scaleGuide, mIsSelected ? selectedScaleGuideBorderPaint : scaleGuideBorderPaint);
//
//            // Dibujar línea del indicador de escala.
//            canvas.drawLines(scaleGuide, mIsSelected ? selectedScaleGuidePaint : scaleGuidePaint);
//
//            // Dibujar medida de la escala.
//            canvas.drawText(String.format(locale, "%.2f mm", millimetersInScaleGuide), 5, 50,
//                textPaint);
